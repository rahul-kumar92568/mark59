...
package com.mark59.datahunter.pvtest.dsl.helperBeans;
...
public class AsyncMessageaAnalyzerResult extends PolicySelectionCriteria   {
	...
	// for initial implementation only application, applicationStartsWithOrEquals, identifier and useability are populated in PolicySelectionCriteria 
