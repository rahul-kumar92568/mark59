...
import com.mark59.datahunter.pvtest.dsl.pageElements.HtmlTable;
 ...
 */
public class PrintSelectedPoliciesActionPage extends SuperDataHunterActionPage {
	...
	public PrintSelectedPoliciesActionPage( WebDriver driver) {
		...
		printSelectedPoliciesTable  = new HtmlTable(driver, "printSelectedPoliciesTable");
