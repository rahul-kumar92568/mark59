...
/**
 * Concrete implementor of the Tester interface, handling recording of performance metrics in the 
 * <a href= 'https://jmeter.apache.org/api/org/apache/jmeter/samplers/SampleResult.html'>org.apache.jmeter.samplers.SampleResult</a> object
 * <p>
 * While the test is running, values are stored in transactionMap, a temporary Map for ease of access.
 * As transactions are completed they are moved from the temporary map to the more enduring SampleResult for the test run.
 * </p>
 * 
 * @author Philip Webb    
