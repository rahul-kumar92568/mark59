 ...
 * 
 * <p>Specifically revolves around <a href='https://jmeter.apache.org/api/org/apache/jmeter/samplers/SampleResult.html'>org.apache.jmeter.samplers.SampleResult</a></p>
 * 
 * @author Philip Webb    
...
public interface JmeterFunctions {
	 ...
	 * @param dataPointName label for the datapoint
	 * @param dataPointValue value for the datapoint
	 * @param outputDatatype see OutputDatatypes  
	 */
	void userDatatypeEntry(String dataPointName, long dataPointValue,  OutputDatatypes outputDatatype);
