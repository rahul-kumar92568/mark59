...
/**
 * Concrete implementor of the JmeterFunctions interface, handling recording of
 * performance metrics in the <a href=
 * 'https://jmeter.apache.org/api/org/apache/jmeter/samplers/SampleResult.html'>org.apache.jmeter.samplers.SampleResult</a>
 * object.
 *
 * Designed to additionally handle Selenium related functions with the framework, in particular screenshots.  
 * 
