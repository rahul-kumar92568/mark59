...
public abstract class SeleniumAbstractJavaSamplerClient  extends AbstractJavaSamplerClient {
	...
	static {
		...
		staticMap.put("______________________ driver settings: ________________________", "Refer Mark59 User Guide: http://pv-central.auiag.corp:81/mark59guides/Mark59_User_Guide.html" );	
		staticMap.put(SeleniumDriverFactory.DRIVER,						AppConstants.DEFAULT_JMETER_MODE);
